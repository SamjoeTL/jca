        ...
        <div class="content-body">
          <div class="row">
              <div class="col-12">
                  <div class="card">
                      <div class="card-body">
                          <form id="jquery-val-form" class="forms-sample" action="{{route('admin.home.update')}}" method="post" enctype="multipart/form-data" id="formdosen">
                            <input type="hidden" name="id" value="{{$data1->id}}">
                              <div class="row">
                                  <div class="form-group col-md-12">
                                      <label class="col-sm-12 col-form-label"><b>Nama Home</b></label>
                                      <div class="col-sm-12">
                                          <input type="text" name="nama" class="form-control" value="{{$data1->nama}}" required>
                                      </div>
                                  </div>

                                  <div class="form-group col-12">
                                    <label class="col-sm-12 col-form-label"><b>Deskripsi Home</b></label>
                                    <div class="col-sm-12">
                                      <div class="form-label-group mb-0">
                                          <textarea data-length="300" class="form-control char-textarea" rows="2" name="deskripsi" id="deskripsi">{{$data1->deskripsi}}</textarea>
                                      </div>
                                      @php
                                          $strlenitem = Str::length($data1->deskripsi);
                                      @endphp
                                      <small class="textarea-counter-value float-right"><span class="char-count">{{$strlenitem}}</span> / 300 </small>
                                    </div>
                                  </div>
                                  ...
                                  <div class="form-group col-12">
                                    ...
                                    <label class="col-sm-12 col-form-label"><small>*Dapat menambahkan lebih dari 1 gambar <b>(gambar teratas disetting menjadi cover)</b>, file format <b>.jpg</b> and <b>.jpeg</b>, maximum size 10MB</small></label>
                                  </div>
...
@push('page-js')
    ...
    <script>
        var edit = 0;
            ...
            $('.upload-photo').filepond('addFile', '{{ asset($data1->gambar) }}');
      </script>
