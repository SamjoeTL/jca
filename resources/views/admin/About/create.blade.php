        ...
        <div class="content-body">
          <div class="row">
              <div class="col-12">
                  <div class="card">
                      <div class="card-body">
                          <form id="jquery-val-form" class="forms-sample" action="{{route('admin.about.store')}}" method="post" enctype="multipart/form-data" id="formdosen">
                              <div class="row">
                                  <div class="form-group col-md-12">
                                      <label class="col-sm-12 col-form-label"><b>Nama foto about</b></label>
                                      <div class="col-sm-12">
                                  ...
                                  <div class="form-group col-12">
                                    <label class="col-sm-12 col-form-label"><b>Deskripsi foto about</b></label>
                                    <div class="col-sm-12">
                                      <div class="form-label-group mb-0">
                                          <textarea data-length="500" class="form-control char-textarea" rows="2" name="desk" id="desk"></textarea>
                                      </div>
                                  ...
                                  <div class="form-group col-12">
                                    ...
                                    <label class="col-sm-12 col-form-label"><small>*Dapat menambahkan lebih dari 1 foto <b>(foto teratas disetting menjadi cover)</b>, file format <b>.jpg</b> and <b>.jpeg</b>, maximum size 2MB</small></label>
                                  </div>
