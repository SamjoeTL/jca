    ...
    <div class="content-body">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form id="jquery-val-form" class="forms-sample" action="{{route('admin.about.store')}}"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 ">
                                    <div class="d-flex align-items-center mx-0 mt-50">
                                        ...
                                        <input type="radio" id="left" name="position" value="1" class="custom-control-input" checked required>
                                        <label class="custom-control-label" for="left">Left</label>
                                        </div>
                                        <div class="custom-control custom-control-danger custom-radio mr-3">
                                        <input type="radio" id="center" name="position" value="2" class="custom-control-input">
                                        <label class="custom-control-label" for="center">Center</label>
                                        </div>
                                        <div class="custom-control custom-control-danger custom-radio">
                                        <input type="radio" id="right" name="position" value="3" class="custom-control-input">
                                ...
                                <div class="form-group col-md-6">
                                    <div class="d-flex align-items-center mx-0 mt-50">
                                        ...
                                        <div class="custom-control custom-control-danger custom-radio mr-3">
                                        <input type="radio" id="publish" name="status" value="1" class="custom-control-input" checked required>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="subjudul_en" class="form-control">
                                </div>
