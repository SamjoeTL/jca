    ...
    <div class="content-body">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form id="jquery-val-form" class="forms-sample" action="{{route('admin.about.update')}}"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 ">
                                    <div class="d-flex align-items-center mx-0 mt-50">
                                        <label class="col-form-label mr-4"><b>Text Position </b></label>
                                        <div class="custom-control custom-control-danger custom-radio mr-3">
                                        <input type="radio" id="left" name="position" value="1" class="custom-control-input" {{$data->position == 1 ? 'checked':''}} required>
                                        <label class="custom-control-label" for="left">Left</label>
                                        </div>
                                        <div class="custom-control custom-control-danger custom-radio mr-3">
                                        <input type="radio" id="center" name="position" value="2" class="custom-control-input" {{$data->position == 2 ? 'checked':''}}>
                                        <label class="custom-control-label" for="center">Center</label>
                                        </div>
                                        <div class="custom-control custom-control-danger custom-radio">
                                        <input type="radio" id="right" name="position" value="3" class="custom-control-input" {{$data->position == 3 ? 'checked':''}}>
                                ...
                                <div class="form-group col-md-12">
                                    <label class="col-form-label"><b>Sub Title</b> <span class="text-muted">(Indonesia)</span></label>
                                    <input type="text" name="subjudul"  value="{{$data->subjudul}}" class="form-control">
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    <label class="col-form-label"><b>Sub Title</b> <span class="text-muted">(English)</span></label>
                                    <input type="text" name="subjudul_en" value="{{$data->subjudul_en}}" class="form-control">
                                </div>
