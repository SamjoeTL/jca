        ...
        <div class="row">
            <div class="col-12">
                <div class="content-body">
                    <div class="card">
                        <div class="card-body">
                            <form id="jquery-val-form" class="forms-sample" action="{{route('admin.product.update')}}" method="post" enctype="multipart/form-data" >
                                <input type="hidden" name="id" value="{{$data2->id}}">
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label class="col-sm-12 col-form-label"><b>Kategori</b></label>
                                        <div class="col-sm-12">
                                            <select class="form-control show-tick ms select2" id="idkategori" name="idkategori"  data-placeholder="Choose Category" required>
                                                <option></option>
                                                @foreach ($kategori as $k)
                                                    <option value="{{$k->id}}" {{$data2->idkategori == $k->id ? 'selected':''}}>{{$k->nama}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
...
@push('page-js')
    ...
    <script>
        var edit = 0;
            ...
            $('.upload-photo').filepond('addFile', '{{ asset($data2->gambar) }}');
      </script>
