...
<div class="content-wrapper">
    ...
    <div class="content-body">
        <div class="card">
            <div class="card-body">
                <form id="jquery-val-form" class="forms-sample" action="{{route('admin.product.update')}}" method="post"
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <label class="col-form-label"><small>* File format <b>.jpg</b> and <b>.jpeg</b>, maximum
                                    size 1MB</small></label>
                        </div>

                        <div class="form-group col-md-12">
                            <label class="col-form-label"><b>File Catalog</b></label>
                            <input type="file" class="dropify" name="files" data-allowed-file-extensions="pdf"
                                data-max-file-size="5M" @if($data->file != null) data-default-file="{{asset($data->file)}}" @endif>
                            <label>* Format file <b>.pdf</b>, ukuran maksimal 5MB</label>
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            <label class="col-form-label"><b>Nama</b> <span class="text-muted">(Indonesia)</span></label>
                        ...
                        <div class="form-group col-md-12">
                            <label class="col-form-label"><b>Name</b> <span class="text-muted">(English)</span></label>
                            <input type="text" name="nama_en" class="form-control" value="{{$data->nama_en}}" required>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <button type="submit" id="btn-submit" class="btn btn-icon btn-block btn-success mt-1"><i
...
<script>
    ...
    $('.upload-photo').filepond('addFile', '{{ asset($data->gambar) }}');
