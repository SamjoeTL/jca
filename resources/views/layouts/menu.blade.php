...
<li class="{{ request()->is('admin/admin-about*') ? 'active' : '' }} nav-item"><a class="d-flex align-items-center" href="{{route('admin.about')}}"><i data-feather='thumbs-up'></i><span class="menu-title text-truncate">About</span></a></li>
