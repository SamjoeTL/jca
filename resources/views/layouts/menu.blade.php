...
<li class="{{ request()->is('admin/product*') ? 'active' : '' }} nav-item"><a class="d-flex align-items-center" href="{{route('admin.product')}}"><i data-feather='thumbs-up'></i><span class="menu-title text-truncate">Product</span></a></li>
<li class="{{ request()->is('admin/sosmed*') ? 'active' : '' }} nav-item"><a class="d-flex align-items-center" href="{{route('admin.sosmed')}}"><i data-feather='phone'></i><span class="menu-title text-truncate">Sosmed</span></a></li>
