...
<li class="{{ request()->is('dashboard*') ? 'active' : '' }} nav-item"><a class="d-flex align-items-center" href="{{route('dashboard')}}"><i data-feather="home"></i><span class="menu-title text-truncate">Dashboard</span></a></li>
...
<li class="{{ request()->is('admin/service*') ? 'active' : '' }} nav-item"><a class="d-flex align-items-center" href="{{route('admin.service')}}"><i data-feather='map-pin'></i><span class="menu-title text-truncate">Service</span></a></li>
...
<li class="{{ request()->is('admin/sosmed*') ? 'active' : '' }} nav-item"><a class="d-flex align-items-center" href="{{route('admin.sosmed')}}"><i data-feather='thumbs-up'></i><span class="menu-title text-truncate">Sosmed</span></a></li>
